...
const ContactUs = () => {
  return (
    <section className="relative bg-green-ziti z-40 py-16 px-4 md:px-12 lg:px-24 flex flex-col items-center">
      ...
      <div className="w-full flex flex-col md:flex-row justify-between gap-x-20">
        <div className="w-full container pl-40 md:w-1/2">
          <p className=" jdid text-lg text-white mb-2">Write to us</p>
          ...
          <form className="w-full items-center">
            ...
            <button
              type="submit"
              className="p-3 w-full md:w-auto  px-6 border-2 border-yellow-gold1 pl-10 pr-10 ml-70 text-white rounded-md hover:bg-yellow-gold1 hover:text-white transition-all"
            >
              Send
            </button>
          </form>
        ...
        <div className="w-full md:w-1/2 items-center text-center text-white">
          <div className="container mt-20">
            <h2 className="text-3xl font-semibold mb-4">Additional Info</h2>
            <p className="mb-2">📍 Address: Example Street, City, Country</p>
